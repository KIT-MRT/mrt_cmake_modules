...
# define rosparam_handler macro for compability
...
macro(generate_ros_interface_files)
    if(NOT COMMAND generate_ros_parameter_files)
        message(FATAL_ERROR "Dependency rosinterface_handler could not be found. Did you add it to your package.xml?")
    endif()
endmacro()
