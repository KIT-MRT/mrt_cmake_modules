...
find_library(TENSORFLOW_TRT_LIBRARY
  NAMES tftrt
  )
...
if(TENSORFLOW_TRT_LIBRARY)
    set(TENSORFLOW_LIBRARY ${TENSORFLOW_TRT_LIBRARY} ${TENSORFLOW_LIBRARY})
endif(TENSORFLOW_TRT_LIBRARY)
