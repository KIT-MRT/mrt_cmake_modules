...
IF(NOT QT_QMAKE_EXECUTABLE)
  FIND_PROGRAM(QT_QMAKE_EXECUTABLE_FINDQT NAMES qmake qmake5 qmake-qt5
               PATHS "${QT_SEARCH_PATH}/bin" "$ENV{QTDIR}/bin" "/usr/lib/x86_64-linux-gnu/qt5/bin/qmake")
...
ELSE(NOT MrtQt5_FIND_COMPONENTS)
  SET(_COMPONENTS ${MrtQt5_FIND_COMPONENTS})
ENDIF(NOT MrtQt5_FIND_COMPONENTS)

FOREACH(_COMPONENT ${_COMPONENTS})
  STRING(TOUPPER ${_COMPONENT} _COMPONENT_UPPER)
  IF(NOT QT_${_COMPONENT_UPPER}_FOUND)
    IF(MrtQt5_FIND_REQUIRED)
      find_package(${_COMPONENT} ${QT_MIN_VERSION} REQUIRED )
    ELSE(MrtQt5_FIND_REQUIRED)
      find_package(${_COMPONENT} ${QT_MIN_VERSION} QUIET)
    ENDIF(MrtQt5_FIND_REQUIRED)

    SET(QT_${_COMPONENT_UPPER}_INCLUDE_DIR ${${_COMPONENT}_INCLUDE_DIRS})
    ...
    SET(QT_${_COMPONENT_UPPER}_FOUND ${${_COMPONENT}_FOUND})
