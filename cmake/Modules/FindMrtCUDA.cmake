...
if(NOT TARGET cuda_compiler_flags)
    ...
    if(${CMAKE_VERSION} VERSION_LESS "3.9.0")
        ...
        target_compile_options(cuda_compiler_flags INTERFACE
            -Wno-deprecated-gpu-targets;-std=c++14
            $<$<CONFIG:Debug>:-lineinfo;-g;--compiler-options;-fPIC>
            $<$<NOT:$<CONFIG:Debug>>-O3;--compiler-options;-fPIC>
            )
        target_compile_definitions(cuda_compiler_flags
        ...
        target_compile_features(cuda_compiler_flags INTERFACE
            cxx_std_14
            )
        target_include_directories(cuda_compiler_flags INTERFACE
