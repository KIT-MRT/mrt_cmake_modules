function(mrt_init_testing)
    ...
    if(NOT TARGET init_tests)
        ...
        add_test(build_tests ${CATKIN_ENV} bash -c "\"${CMAKE_COMMAND}\" --build ${CMAKE_BINARY_DIR} ${make_jobs} --target tests && ${pre_test_cmd}")
...
function(_mrt_add_nosetests_impl folder)
    ...
    set(cmd "${NOSETESTS} -P --process-timeout=${_nose_TIMEOUT} ${tests} --with-xunit --xunit-file=\"${result_xml_path}\" ${covarg}")
